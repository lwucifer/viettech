<template>
    <view :class="disabled ? 'uni-list-item--disabled' : ''"
        ...
        <view class="uni-list-item__container">
            ...
            <view v-else-if="showExtraIcon"
                  class="uni-list-item__icon">
                <uni-icons :color="extraIcon.color"
                           :size="extraIcon.size"
                           :type="extraIcon.type"
            ...
            <view v-if="showBadge || showArrow || showSwitch  || showText"
                ...
                <uni-badge v-if="showBadge"
                           :type="badgeType"
                           :text="badgeText" />
                <switch v-if="showSwitch"
                        :disabled="disabled"
                        :checked="switchChecked"
                        @change="onSwitchChange" />
                <view v-if="showText">{{text}}</view>
                <uni-icons v-if="showArrow"
                           :size="20"
                           class="uni-icon-wrapper"
                           color="#bbb"
                           type="arrowright" />
